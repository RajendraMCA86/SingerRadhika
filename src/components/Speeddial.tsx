...
export default function Speeddial({ direction, actionButtons }: SpeedialProps) {
  ...
  const getGlassyClasses = () => {
    return "backdrop-filter backdrop-blur-xl bg-white  rounded-xl shadow-lg transition-all duration-300";
  };
  ...
  return (
    ...
    >
      <button
        ...
        className={`${getGlassyClasses()} order-0 order-1 flex items-center p-3 bg-gradient-to-r from-red-600 to-red-700 rounded-lg hover:from-red-700 hover:to-red-800 transition-all `}
      >
        Follow On 
